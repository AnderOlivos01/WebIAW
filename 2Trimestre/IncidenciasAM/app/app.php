        ...
        <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="ModalLabel">Editar incidencia</h3>
                </div>
                ...
                <?php
                    if($res_todas_consultas->num_rows>0){
                        ...
                        for($i=0;$i<$res_todas_consultas->num_rows;$i++){
                            ...
                            <button type='button' class='btn btn-primary boton-editar' data-toggle='modal' onclick='editar_incidencia(".$fila['id'].")'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
