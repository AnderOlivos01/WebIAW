                ...
                <?php
                    if($res_todas_consultas->num_rows>0){
                        ...
                        for($i=0;$i<$res_todas_consultas->num_rows;$i++){
                            ...
                            <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#Modal'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
